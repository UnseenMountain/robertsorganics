            ...
            <Card className="text-center">
                ...
                <div className="color">
                    ...
                    <div className="pad">
                            ...
                            <a variant="primary" className="pad" href="https://twitter.com/OrganicsRoberts">
                            ...
                            <a variant="primary" className="pad" href="https://www.facebook.com/">
                            ...
                            <a variant="primary" className="pad" href="https://www.instagram.com/">
